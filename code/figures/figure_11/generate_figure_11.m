...
filterSummary = load(velocityFile, "wavelengthFilter");
validate_wavelength_filter(filterSummary);
...
if ~isfield(source, "wavelengthFilter")
    error("Figure11:MissingFilterProvenance", ...
...
if ~isstruct(filter) || any(~isfield(filter, cellstr(required))) || ...
    ...
    error("Figure11:UnexpectedWavelengthFilter", ...
